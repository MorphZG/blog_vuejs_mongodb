<script setup></script>
<template>
  <h1 class="mb-5 ml-10 font-roboto text-2xl font-thin">>> About</h1>
  <section class="flex bg-neutral-800 p-5">
    <img
      class="m-5 shrink-0 rounded-3xl"
      src="../assets/profilepic01.jpeg"
      alt=""
      width="10%"
      height="10%"
    />
